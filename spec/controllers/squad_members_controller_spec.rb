...
RSpec.describe SquadMembersController, type: :controller do

  # This should return the minimal set of attributes required to create a valid
  # SquadMember. As you add validations to SquadMember, be sure to
  ...
  # SquadMembersController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #edit" do
    it "returns a success response" do
      squad_member = SquadMember.create! valid_attributes
      get :edit, params: {id: squad_member.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new SquadMember" do
        expect {
          post :create, params: {squad_member: valid_attributes}, session: valid_session
        }.to change(SquadMember, :count).by(1)
      end

      it "redirects to the created squad_member" do
        post :create, params: {squad_member: valid_attributes}, session: valid_session
        expect(response).to redirect_to(SquadMember.last)
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "redirects to the squad_member" do
        squad_member = SquadMember.create! valid_attributes
        put :update, params: {id: squad_member.to_param, squad_member: valid_attributes}, session: valid_session
        expect(response).to redirect_to(squad_member)
      end
    end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the squad_members list" do
      squad_member = SquadMember.create! valid_attributes
      delete :destroy, params: {id: squad_member.to_param}, session: valid_session
      expect(response).to redirect_to(squad_members_url)
    end
  end
